    ...
    public class SeedData
    {
        ...
        internal static void Seed(ApplicationDbContext context)
        {
			...
			context.Styles.Add(new Style
			{
				...
				StyleTags = new List<StyleTagAssociation> { new StyleTagAssociation { StyleCode = "bjcp-2015.k-lsch", StyleTagCode = "bjcp-2015.pale-ale-family"}}
			});
			...
			context.Styles.Add(new Style
			{
				...
				StyleTags = new List<StyleTagAssociation> { new StyleTagAssociation { StyleCode = "bjcp-2015.m-rzen", StyleTagCode = "bjcp-2015.amber-lager-family"}}
			});
			...
			context.Styles.Add(new Style
			{
				...
				StyleTags = new List<StyleTagAssociation> { new StyleTagAssociation { StyleCode = "bjcp-2015.bi-re-de-garde", StyleTagCode = "bjcp-2015.amber-ale-family"}}
			});

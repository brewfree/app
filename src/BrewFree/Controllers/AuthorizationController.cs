...
using BrewFree.ViewModels.Shared;
using BrewFree.ViewModels.Authorization;
...
namespace BrewFree.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> Authorize(OpenIdConnectRequest request)
        {
            ...
            if (application == null)
            {
                return View("Error", new ErrorViewModel
                {
                    ...
                    Description = "Details concerning the calling client application cannot be found in the database"
                });
            }
        ...
        public IActionResult LogoutRequest(OpenIdConnectRequest request)
        {
